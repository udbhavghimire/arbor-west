...
<head>
    ...
    <meta name="description"
        content="Arbor West by Caivan Communities is an upcoming pre construction singles & towns development in Bovaird Dr W & Mississauga Rd, Brampton.">
    <meta name="keywords"
        content="Arbor West Brampton , Arbor West, Arbor West Homes Brampton, Caivan Communities, Pre construction in brampton,  Singles and towns in Brampton, Pre consruction single and towns brampton">
...
<body>
            ...
            <div class=" hero-container">
                <div>
                    <h1 class="main-titlee pb-0  mb-0 mt-2 mt-md-0" data-aos="fade-up" data-aos-duration="2000"
                        data-aos-delay="50">Arbor West Homes</span>
                    </h1>
                    <p class=" headline-textt mt-0 pt-3 text-white" data-aos="fade-up" data-aos-duration="2000"
                        data-aos-delay="50">Coming to Brampton - Townhomes & Single Detached Homes <br> Launching in
                        September 2023</p>
                </div>
            </div>
        </div>
            ...
            <div class="container pt-3 " id="newcondos">
                ...
                <div class="pt-md-5 pt-5">
                    <h2
                        ...
                        <span class="bg-color">Arbor West Townhomes </span>
                    </h2>
                    <span class="small-text text-center d-flex justify-content-center custom-underline pb-3 mx-1">Arbor
                        West community in Brampton offering Townhomes with unparalleled features
                        and finishes. </span>
                </div>
                <div class="rounded-3">
                    <div class="d-flex justify-content-between pb-3">
                        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 justify-content-center g-4 mt-2">
                            <a href="./images/towns.jpeg" target="_blank" class="col">
                                <div class="afte-proj">
                                    <img src="./images/towns.jpeg" alt="Arbor West Townhomes"
                                        class="shadow-lg rounded-mine imghei">
                                </div>
                            </a>
                            <a href="./images/towns-1.jpeg" target="_blank" class="col">
                                <div class="afte-proj">
                                    <img src="./images/towns-1.jpeg" alt="Arbor West Townhomes"
                                        class="shadow-lg rounded-mine imghei">
                                </div>
                            </a>
                            <a href="./images/towns-2.jpeg" target="_blank" class="col">
                                <div class="afte-proj">
                                    <img src="./images/towns-2.jpeg" alt="Arbor West Townhomes"
                                        class="shadow-lg rounded-mine imghei">
                                </div>
                            </a>
                            <a href="./images/towns-3.jpeg" target="_blank" class="col">
                                <div class="afte-proj">
                                    <img src="./images/towns-3.jpeg" alt="Arbor West Townhomes"
                                        class="shadow-lg rounded-mine imghei">
                                </div>
                            </a>
                            <a href="./images/towns-4.jpeg" target="_blank" class="col">
                                <div class="afte-proj">
                                    <img src="./images/towns-4.jpeg" alt="Arbor West Townhomes"
                                        class="shadow-lg rounded-mine imghei">
                                </div>
                            </a>
                        </div>
    ...
    <section>
        <div class="container pt-md-5 pt-5" id="location">
            ...
            <div class="py-5" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
                ...
                <div class="row">
                    <div class="col">
                        <img src="images/Arbor-West-Homes-Map-View-of-Project-Location-2-v3-full.jpg" class=" imghei"
                            alt="Arbor West Homes Map View of Project Location">
                    </div>
    ...
    <section>
        <div class="container pt-md-5 pt-5" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
            ...
            <div class="pt-4 ">
                <span class="small-text text-center d-flex justify-content-center custom-underline pb-3 textt">(Arbor
                    West Homes)
        ...
        <div class="container pt-md-5 pt-5" id="location">
            ...
            <div class="py-5" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
                ...
                <span class="small-text text-center d-flex justify-content-center custom-underline pb-3 px-2">Walk
                    around the neighbourhood near Arbor West Homes</span>
        ...
        <div class="container pt-md-5 pt-5" id="location">
            ...
            <div class="pt-5" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
                ...
                <span class="small-text text-center d-flex justify-content-center custom-underline pb-3 px-2">See the
                    neighbourhood near Arbor West Homes</span>
            </div>

            <img src="images/arbor-west-neighbourhood.jpg" class="img-fluid" alt="Arbor West Homes Neighbourhood ">
        </div>
    </section>
    ...
    <section data-aos="fade-up">
        <div class="container pt-md-5 pt-5" id="location">
            ...
            <div class="pt-5" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
                ...
                <span class="text-center d-flex justify-content-center mx-widthh pb-4 px-2">Arbor West homes are
            ...
            <div class="accordion accordion-flush pt-4" id="accordionFlushExample">
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                        ...
                        <div class="accordion-body">Arbor West is expected to be launched by Caivan Communities in
                            September, 2023 </div>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo"
                        data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">Arbor West is Brampton's most anticipated Master-Planned Community
                            that will include townhomes & Single Detached homes. Arbor West will be built in prime
                            location of Brampton ( Major Intersection : Bovaird Drive & Mississauga Road ). Its close
                            proximity to Mount Pleasent Go station and the big stores like Walmart, Restaurants, Banks,
                            Day care center makes Arbor west one of the most desirable pre construction townhome &
                            single project in Brampton. Introducing Arbor West, Brampton's most anticipated
                            Master-Planned Neighbourhood, featuring Caivan's award-winning singles and towns.</div>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseThree" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body">Arbor West is a project from Caivan Communities. Caivan Communities
                            is a esteemed team of real estate builders and developers based in Ottawa. They have several
                            real estate developments in their portfolio from stunning townhome communities, to single
                            homes and modern condominium buildings.</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="pt-5 mt-5 " data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
                <div class="row mx-0 ">
                    ...
                    <div class="registertext px-4 d-flex justify-content-center align-items-center text-center ">
                        <p>Register today and get the first update on Arbor West coming up in Brampton
                        </p>
                    </div>
